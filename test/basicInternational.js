(function basicIndianTests() {
  ...
  {
    tap.assert(n.toInternationalWords(number) === word,
               number + ' should equal "' + word + '", actually equals "' + n.toInternationalWords(number) + '"');
  }
  ...
  assertNumber(999999999, 'nine hundred ninety nine million nine hundred ninety nine thousand nine hundred ninety nine');
  ...
  assertNumber(9999999999, 'nine billion nine hundred ninety nine million nine hundred ninety nine thousand nine hundred ninety nine');
  ...
  assertNumber(99999999999, 'ninety nine billion nine hundred ninety nine million nine hundred ninety nine thousand nine hundred ninety nine');
  assertNumber(100000000000, 'one hundred billion');
  assertNumber(999999999999, 'nine hundred ninety nine billion nine hundred ninety nine million nine hundred ninety nine thousand nine hundred ninety nine');
